...
<body>
    ...
    <div class="container conatiner_landing_page">
        ...
        <div class="row">
            <p class="text-start fw-bold"> Breng jouw spel naar het volgende niveau op het grote scherm! Met een privé-theater dat speciaal voor jou en je crew is gereserveerd, heb je nog nooit eerder zo gespeeld. Maak er een toernooi van! </p>
            <p class="text-start fw-bold"> Neem je eigen favoriete Xbox One-spellen mee of kies uit het aanbod van je theater. </p>
