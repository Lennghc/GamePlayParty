        ...
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-green">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <?= isset($_SESSION['user']) && $_SESSION['user']->role_id == 4 ? '<li><a href="index.php?con=content&op=updateHome" class="nav-link px-0 align-middle"><i class="fa fa-edit"></i> <span class="ms-1 d-none d-sm-inline text-white">Bewerk Homepagina</span></a></li>' : null ?>
                    <?= isset($_SESSION['user']) && $_SESSION['user']->role_id == 4 ? '<li><a href="index.php?con=content&op=updateAbout" class="nav-link px-0 align-middle"><i class="fa fa-edit"></i> <span class="ms-1 d-none d-sm-inline text-white">About us</span></a></li>' : null ?>
